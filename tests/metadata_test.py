...
def test_uses_earliest_and_latest_slots(request, vm_test_config):
    simple_script = data_file_path(request, os.path.join('scripts', 'simple.script'))
...
def test_rejects_if_two_in_policy_no_version(request, vm_test_config):
    ...
    try:
        ...
        assert "Incorrect looking policy versions in file 'policy_bad_version.json'" in str(e)
...
def test_rejects_if_duplicate_names_in_dir(request, vm_test_config):
    ...
    try:
        ...
        assert "Found duplicate asset name '33568ad11f93b3e79ae8dee5ad928ded72adcea719e92108caf1521b.WildTangz 1'" in str(e)
